...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [ponnuty] --*' + 
                                    '\n*ponnuty an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [ponnuty] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
...
About
"
 https://github.com/vychappansir/ponnuty/blob/master/bot.js#:~:text=Skip%20to%20content,About
