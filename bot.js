...
Lisamwol
Public
forked from Lfahermit/Lisamwol
Code
Pull requests
Actions
Projects
...
Lfahermit Update bot.js
 13 contributors
+1
973 lines (931 sloc)  62.6 KB
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [Lisamwol] --*' + 
                                    '\n*Lisamwol an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [Lisamwol] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
...
About
"
 https://github.com/vychappansir/Lisamwol/blob/master/bot.js#:~:text=Skip%20to%20content,About
